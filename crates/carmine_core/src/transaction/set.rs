...
impl<'a> SetTxn<'a> for Transaction<'a> {
    fn set(&self, key: Key, value: Value) -> Result<()> {
        ...
        match (self.bucket.key_type, self.bucket.value_type) {
            ...
            (KeyType::String, ValueType::Byte) => {
                ...
                set_typed!(write_txn, name, k, v.as_slice(), String, &[u8]);
            }
            ...
            (KeyType::Number, ValueType::Byte) => {
                ...
                let v = val_to_byte(value);
                set_typed!(write_txn, name, k, v.as_slice(), Number, &[u8]);
            }
            ...
            (KeyType::Int, ValueType::Int) => set_typed!(
                write_txn,
                name,
                key_to_int(key),
                val_to_int(value),
            ...
            (KeyType::Int, ValueType::Byte) => {
                ...
                let v = val_to_byte(value);
                set_typed!(write_txn, name, k, v.as_slice(), Int, &[u8]);
            }
        }
